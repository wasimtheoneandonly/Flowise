...
class UnstructuredFile_DocumentLoaders {
    ...
    async init(nodeData, _, options) {
        ...
        if (fileBase64) {
            ...
            if ((0, validator_1.isPathTraversal)(filePath)) {
            ...
            const sanitizedFilename = (0, sanitize_filename_1.default)(parsedPath.base);
            if (!sanitizedFilename || sanitizedFilename.trim() === '') {
                throw new Error('Invalid filename after sanitization');
            }
            const sanitizedFilePath = path_1.default.join(parsedPath.dir, sanitizedFilename);
            if (!path_1.default.isAbsolute(sanitizedFilePath)) {
                throw new Error('File path must be absolute');
            }
            if (sanitizedFilePath.includes('..')) {
                throw new Error('Invalid file path - directory traversal not allowed');
            }
            const loader = new unstructured_1.UnstructuredLoader(sanitizedFilePath, obj);
